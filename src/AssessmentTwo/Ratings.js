...
const Ratings=(props)=>{
    const [res,setRes]=useState(props.data.sort((a,b)=>Number(a.rating)-Number(b.rating)))
        ...
        <div className="row">
            {
                res.map((item)=>(
                    <div className="col-sm-12 col-lg-3">
                        ...
                        <img class="card-img-top" style={{height: '300px'}} src={item.image} alt="Card image cap"></img>
